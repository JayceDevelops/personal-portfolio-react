export default function Project({ name, description, github, website, tools, image }) {
    return (
        <div className="group flex flex-row h-full w-full rounded-xl border border-white/15 bg-white/5 overflow-hidden shadow-lg shadow-black/30 transition-all duration-300 hover:-translate-y-1 hover:border-white/30 hover:shadow-xl">
            <div className="h-full w-2/5 shrink-0 overflow-hidden bg-black/20 flex items-center justify-center">
                {image ? (
